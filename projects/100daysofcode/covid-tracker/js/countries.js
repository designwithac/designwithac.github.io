...
const change_country_bttn = document.querySelector('.change-country');
const close_bttn = document.querySelector('.close');
...
change_country_bttn.addEventListener('click', function(){
    input.value = "";
    reserCountryList();
    search_country_element.classList.toggle('hide');
    search_country_element.classList.add('fade-in');
});
...
// country filter
// input event fires up only when the input value is changes
